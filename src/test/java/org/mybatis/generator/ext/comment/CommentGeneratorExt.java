...
//        super.addJavadocTag(javaElement, markAsDoNotDelete);
        ...
        javaElement.addJavaDocLine(" * @开发日期 " + new SimpleDateFormat("yyyy/MM/dd").format(new Date()));
        javaElement.addJavaDocLine(" */");
    }
    ...
    public void addClassComment(InnerClass innerClass, IntrospectedTable introspectedTable, boolean markAsDoNotDelete) {
        ...
        innerClass.addJavaDocLine(" * @AUTO ");
        innerClass.addJavaDocLine(" * @Author " + properties.getProperty("author"));
        innerClass.addJavaDocLine(" * @开发日期 " + new SimpleDateFormat("yyyy/MM/dd").format(new Date()));
        innerClass.addJavaDocLine(" */");
    ...
    public void addEnumComment(InnerEnum innerEnum, IntrospectedTable introspectedTable) {
        ...
        innerEnum.addJavaDocLine(" * @AUTO ");
        innerEnum.addJavaDocLine(" * @Author " + properties.getProperty("author"));
        innerEnum.addJavaDocLine(" * @开发日期 " + new SimpleDateFormat("yyyy/MM/dd").format(new Date()));
        innerEnum.addJavaDocLine(" */");
    }
    ...
    private String getFieldComment(IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
