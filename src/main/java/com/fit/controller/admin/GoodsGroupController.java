...
@Slf4j
@Controller
@RequestMapping("/admin/goods/group")
public class GoodsGroupController extends BaseController {
    ...
    public R list(HttpServletRequest request) {
        ...
        List<GoodsGroup> list = service.findList(map);
    ...
    public String edit(Long id, Model model) {
        if (isNotEmpty(id)) {
            GoodsGroup bean = service.get(id);
            model.addAttribute("bean", bean);
        }
        return "admin/luna/goods/groupEdit";
    }
