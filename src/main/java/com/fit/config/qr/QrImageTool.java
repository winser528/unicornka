...
public class QrImageTool {
    ...
    private static Logger log = LoggerFactory.getLogger(QrImageTool.class);
    ...
    public static String base64QrImage(String content) {
        return base64QrImage(content, 300, 300);
    }
     ...
     * @return
     */
    public static String base64QrImage(String content, int width, int height) {
        try {
            Map<EncodeHintType, Object> hints = new HashMap<EncodeHintType, Object>();
            hints.put(EncodeHintType.CHARACTER_SET, "UTF-8");
            BitMatrix bitMatrix = new MultiFormatWriter().encode(content, BarcodeFormat.QR_CODE, width, height, hints);// 生成矩阵
            BufferedImage image = MatrixToImgWriter.toBufferedImage(bitMatrix);
    ...
    public static void createSimpleQr(String content, String destImagePath) {
        createSimpleQr(content, 300, 300, destImagePath);
    }
     ...
     * @param outPath 保存地址
     */
    public static void createSimpleQr(String content, int width, int height, String outPath) {
        ...
        try {
            ...
            MatrixToImgWriter.writeToStream(bitMatrix, format, output);// 输出图像
        } catch (Exception e) {
    ...
    public static void main(String[] args) throws IOException {
        String savePath = QrImageTool.class.getClassLoader().getResource("").getFile();
        QrImageTool.createSimpleQr("http://www.baidu.com?a=123", 300, 300, savePath.replace("classes", "maven-archiver") + File.separator + "1.jpg");
//        QrImage para = new QrImage.Builder()
//                .setFileOutputPath(savePath.replace("classes", "maven-archiver") + File.separator + "1.jpg")
